...
export default function CoursesCompanies({ data }) {
  return (
    <Container>
      ...
      >
        <p>
          Con base en un análisis de necesidades, diseñamos data a la medida de
          las necesidades de su empresa y nos adaptamos también a sus
          necesidades de horario para que el curso no interfiera con las
          actividades de sus colaboradores.
        </p>
        <p>
          Si su empresa no tienen necesidades específicas, pero el dominio del
          inglés es parte del programa de capacitación de la empresa, les
          ofrecemos descuentos y beneficios especiales en nuestros cursos de
          Inglés General.
        </p>
        <ButtonSaberMas />
      </TextIlustration>
